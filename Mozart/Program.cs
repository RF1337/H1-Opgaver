    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < menuets.GetLength(1); i++)
            {
                ...
                files[i] = @"C:\Users\zbcrafe\source\repos\Mozart\Waves\M" + menuets[randomNum - 2, i] + ".wav";
            }
            ...
            for (int i = 0; i < trios.GetLength(1); i++)
            {
                ...
                Console.WriteLine(randomNum);
                files[i] = @"C:\Users\zbcrafe\source\repos\Mozart\Waves\T" + trios[randomNum - 1, i] + ".wav";
            }
